 ...
 *   user's finger and snaps by x to the nearest lollipop, resting on its head. Usually set for you by
 *   passing a `crosshair` to the chart rather than configured here directly.
