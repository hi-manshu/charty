 ...
 * gesture overhead on read-only charts. When [enableScrub] is `true`, a
 * drag-to-track tooltip gesture is layered on top.
 */
internal fun createNormalizedHorizontalBarChartModifier(
    ...
    onTooltipStateChange: (TooltipState?, NormalizedHorizontalBarSegment?) -> Unit,
    enableScrub: Boolean = false,
): Modifier {
    val tooltipContentBuilder = { segment: NormalizedHorizontalBarSegment, rect: Rect ->
