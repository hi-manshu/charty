...
/**
 * The composable layer drawn over the wavy chart's canvas: the Compose-overlay tooltip and the
 ...
 * @param tooltipItem The tapped wave the tooltip describes, or `null` when nothing is selected.
