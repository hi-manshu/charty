...
/**
 * The composable layer drawn over the stacked area chart's canvas: the Compose-overlay tooltip and
 * the crosshair label host, both filling the chart box so they position themselves against the same
 ...
 * @param tooltipItem The tapped segment the tooltip describes, or `null` when nothing is selected.
...
internal fun BoxScope.StackedAreaChartOverlays(
    ...
    tooltip: ChartTooltip<StackedAreaPoint>,
    tooltipItem: StackedAreaPoint?,
