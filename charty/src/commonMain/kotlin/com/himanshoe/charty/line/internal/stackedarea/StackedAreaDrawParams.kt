 ...
 * @property onAreaClick Invoked when an area is tapped; `null` skips collecting segment bounds.
 * @property areaSegmentBounds Collects each drawn segment's rect, path, and data, for hit-testing.
