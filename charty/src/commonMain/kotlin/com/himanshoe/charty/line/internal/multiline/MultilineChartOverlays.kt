...
/**
 * The composable layer drawn over the multiline chart's canvas: the crosshair label host, filling
 * the chart box so it can position itself against the same pixel space the canvas drew into.
 * Renders nothing when no crosshair is configured.
 *
